...
TRANSLATIONS = {
    "tr": {
        ...
        "impressum_desc": "Bu sayfa, profesyonel fal/orakel platformlarında kullanılan yasal bilgilendirme yapısına benzer şekilde işletmeci ve iletişim bilgilerini içerir.",
        "impressum_provider_title": "Hizmet Sağlayıcı",
        "impressum_provider_body": "Orakelia • Online Fal Danışmanlığı Platformu (Dijital Hizmet)",
        "impressum_contact_title": "İletişim",
        "impressum_contact_body": "E-posta: support@orakelia.com • Yanıt süresi: 24-48 saat",
        "impressum_responsible_title": "İçerikten Sorumlu",
        "impressum_responsible_body": "Orakelia Platform Yönetimi",
        "impressum_content_title": "İçerik Sorumluluğu",
        "impressum_content_body": "Sayfadaki içerikler özenle hazırlanır ve düzenli olarak gözden geçirilir. Buna rağmen tüm bilgilerin her an eksiksiz, güncel ve hatasız olacağı garanti edilemez.",
        "impressum_links_title": "Harici Bağlantılar",
        "impressum_links_body": "Harici sitelere verilen bağlantıların içerikleri ilgili yayıncının sorumluluğundadır. Bağlantı verildiği anda hukuka aykırı içerik tespit edilmemiştir.",
        "impressum_dispute_title": "Uyuşmazlık ve Tüketici Bilgilendirmesi",
        "impressum_dispute_body": "İhtilaf durumunda önce support@orakelia.com adresi üzerinden doğrudan çözüm süreci yürütülmesi önerilir.",
        ...
        "impressum_copyright_body": "Bu sitedeki metinler, tasarımlar ve platforma ait özgün içerikler telif kapsamında korunur. İzinsiz kopyalama ve çoğaltma yasaktır.",
        "datenschutz_title": "Datenschutz",
        "datenschutz_desc": "Bu gizlilik politikası; profesyonel online fal/orakel platformlarında kullanılan yapıya benzer şekilde, hangi verileri neden işlediğimizi ve haklarınızı açıklar.",
        "datenschutz_controller_title": "Veri Sorumlusu",
        "datenschutz_controller_body": "Veri sorumlusu: Orakelia Platform Yönetimi • İletişim: support@orakelia.com",
        "datenschutz_data_title": "İşlenen Veri Türleri",
        "datenschutz_data_body": "Hesap ve talep süreçlerinde ad-soyad, kullanıcı adı, e-posta, telefon, soru metni, seçilen kartlar, yüklenen görseller, ödeme durumu, sistem günlükleri ve teknik cihaz/oturum verileri işlenebilir.",
        "datenschutz_purpose_title": "İşleme Amaçları",
        "datenschutz_purpose_body": "Veriler; üyelik yönetimi, talep oluşturma, fal yorumlama, ödeme takibi, müşteri iletişimi, güvenlik kontrolleri, hata analizi ve hizmet kalitesini artırma amacıyla kullanılır.",
        "datenschutz_legal_title": "Hukuki Dayanak",
        "datenschutz_legal_body": "Veri işleme; hizmet sözleşmesinin ifası, meşru menfaatler (güvenlik/sistem sürekliliği) ve gerektiğinde açık rıza dayanaklarına göre yürütülür.",
        "datenschutz_storage_title": "Saklama Süresi",
        "datenschutz_storage_body": "Veriler yalnızca gerekli süre boyunca saklanır. Yasal yükümlülük, güvenlik veya muhasebe gereksinimi yoksa kayıtlar periyodik olarak silinir veya anonimleştirilir.",
        "datenschutz_sharing_title": "Üçüncü Taraf Hizmetler",
        "datenschutz_sharing_body": "Ödeme, e-posta iletimi, barındırma ve yapay zeka yorumlama süreçlerinde sözleşmeli hizmet sağlayıcılar kullanılabilir. Bu sağlayıcılarla yalnızca gerekli veri paylaşılır.",
        "datenschutz_cookies_title": "Çerezler ve Oturum",
        "datenschutz_cookies_body": "Platform, güvenli oturum yönetimi ve dil tercihi gibi temel işlevler için teknik çerezler kullanır. Pazarlama amaçlı izleme çerezleri kullanılmaz.",
        "datenschutz_security_title": "Veri Güvenliği",
        "datenschutz_security_body": "Uygulamada erişim kontrolü, parola koruması, HTTPS, oturum güvenliği ve altyapı seviyesinde teknik/organizasyonel önlemler uygulanır.",
        "datenschutz_transfer_title": "Uluslararası Veri Aktarımı",
        "datenschutz_transfer_body": "Kullanılan servis sağlayıcının konumuna göre veriler yurt dışına aktarılabilir. Bu durumda sözleşmesel ve teknik koruma önlemleri uygulanır.",
        "datenschutz_rights_title": "Haklarınız",
        "datenschutz_rights_body": "Yürürlükteki mevzuata göre verilerinize erişim, düzeltme, silme, işleme kısıtlama, itiraz ve veri taşınabilirliği haklarına sahipsiniz.",
        "datenschutz_contact_title": "Gizlilik Başvuruları",
        "datenschutz_contact_body": "Gizlilik talepleriniz için: support@orakelia.com (konu: Datenschutz)",
    ...
    "en": {
        ...
        "impressum_title": "Impressum",
        "impressum_desc": "This page follows the legal disclosure structure commonly used on professional fortune/oracle platforms and provides operator and contact information.",
        "impressum_provider_title": "Service Provider",
        "impressum_provider_body": "Orakelia • Online Fortune Guidance Platform (Digital Service)",
        "impressum_contact_title": "Contact",
        "impressum_contact_body": "Email: support@orakelia.com • Typical response time: 24-48 hours",
        "impressum_responsible_title": "Responsible for Content",
        "impressum_responsible_body": "Orakelia Platform Administration",
        "impressum_content_title": "Content Liability",
        "impressum_content_body": "Platform content is prepared with care and reviewed regularly. However, we cannot guarantee that all information is complete, current, or error-free at all times.",
        "impressum_links_title": "External Links",
        "impressum_links_body": "Content of external websites is the responsibility of their respective operators. At the time of linking, no unlawful content was identifiable.",
        "impressum_dispute_title": "Dispute Resolution",
        "impressum_dispute_body": "In case of a dispute, we recommend contacting support@orakelia.com first to seek a direct and practical resolution.",
        ...
        "impressum_copyright_body": "Texts, designs, and original platform content on this site are protected by copyright. Unauthorized copying or redistribution is prohibited.",
        "datenschutz_title": "Datenschutz",
        "datenschutz_desc": "This privacy policy follows the structure commonly used by professional online fortune/oracle platforms and explains what data we process, why we process it, and which rights you have.",
        "datenschutz_controller_title": "Data Controller",
        "datenschutz_controller_body": "Data controller: Orakelia Platform Administration • Contact: support@orakelia.com",
        "datenschutz_data_title": "Categories of Data Processed",
        "datenschutz_data_body": "During account and reading workflows we may process full name, username, email, phone, question text, selected cards, uploaded images, payment status, system logs, and technical session/device data.",
        "datenschutz_purpose_title": "Purposes of Processing",
        "datenschutz_purpose_body": "Data is processed to manage user accounts, receive requests, generate readings, track payments, provide customer communication, apply security checks, analyze errors, and improve service quality.",
        "datenschutz_legal_title": "Legal Basis",
        "datenschutz_legal_body": "Processing is carried out based on contract performance, legitimate interests (security/service continuity), and consent where required.",
        "datenschutz_storage_title": "Retention Period",
        "datenschutz_storage_body": "Data is stored only as long as necessary for service delivery and legal obligations. Records are periodically deleted or anonymized when retention is no longer required.",
        "datenschutz_sharing_title": "Third-Party Service Providers",
        "datenschutz_sharing_body": "We may use contracted providers for payments, email delivery, hosting, and AI interpretation. Only data required for each purpose is shared.",
        "datenschutz_cookies_title": "Cookies and Session Data",
        "datenschutz_cookies_body": "The platform uses essential technical cookies for secure session management and language preferences. No marketing tracking cookies are used.",
        "datenschutz_security_title": "Data Security",
        "datenschutz_security_body": "We implement access controls, password protection, HTTPS transport security, session safeguards, and infrastructure-level technical/organizational measures.",
        "datenschutz_transfer_title": "International Data Transfers",
        "datenschutz_transfer_body": "Depending on provider locations, data may be processed outside your country. In such cases, contractual and technical safeguards are applied.",
        "datenschutz_rights_title": "Your Rights",
        "datenschutz_rights_body": "Under applicable law, you may request access, correction, deletion, restriction of processing, objection, and data portability where relevant.",
        "datenschutz_contact_title": "Privacy Requests",
        "datenschutz_contact_body": "For privacy requests: support@orakelia.com (subject: Datenschutz)",
    ...
    "de": {
        ...
        "impressum_title": "Impressum",
        "impressum_desc": "Diese Seite folgt der bei professionellen Orakel-/Beratungsplattformen üblichen Impressumsstruktur und enthält Anbieter- sowie Kontaktdaten.",
        "impressum_provider_title": "Diensteanbieter",
        "impressum_provider_body": "Orakelia • Online-Orakelberatungsplattform (Digitale Dienstleistung)",
        "impressum_contact_title": "Kontakt",
        "impressum_contact_body": "E-Mail: support@orakelia.com • Übliche Antwortzeit: 24-48 Stunden",
        "impressum_responsible_title": "Inhaltlich Verantwortlich",
        "impressum_responsible_body": "Orakelia Plattform-Administration",
        "impressum_content_title": "Haftung für Inhalte",
        "impressum_content_body": "Die Inhalte werden mit Sorgfalt erstellt und regelmäßig überprüft. Dennoch kann keine Gewähr für Vollständigkeit, Aktualität und Fehlerfreiheit übernommen werden.",
        "impressum_links_title": "Haftung für Links",
        "impressum_links_body": "Für Inhalte externer Links sind ausschließlich deren Betreiber verantwortlich. Zum Zeitpunkt der Verlinkung waren keine Rechtsverstöße erkennbar.",
        "impressum_dispute_title": "Streitbeilegung",
        "impressum_dispute_body": "Bei Unstimmigkeiten empfehlen wir zunächst die direkte Kontaktaufnahme über support@orakelia.com zur außergerichtlichen Klärung.",
        ...
        "impressum_copyright_body": "Texte, Designs und eigene Plattforminhalte dieser Website sind urheberrechtlich geschützt. Unerlaubte Vervielfältigung oder Weitergabe ist untersagt.",
        "datenschutz_title": "Datenschutz",
        "datenschutz_desc": "Diese Datenschutzerklärung orientiert sich an der bei professionellen Online-Orakelplattformen üblichen Struktur und erklärt, welche Daten wir verarbeiten, zu welchen Zwecken und welche Rechte Sie haben.",
        "datenschutz_controller_title": "Verantwortliche Stelle",
        "datenschutz_controller_body": "Verantwortlich: Orakelia Plattform-Administration • Kontakt: support@orakelia.com",
        "datenschutz_data_title": "Verarbeitete Datenkategorien",
        "datenschutz_data_body": "Im Konto- und Anfrageprozess können Name, Benutzername, E-Mail, Telefon, Fragetext, ausgewählte Karten, hochgeladene Bilder, Zahlungsstatus, Systemprotokolle sowie technische Sitzungs-/Gerätedaten verarbeitet werden.",
        "datenschutz_purpose_title": "Zwecke der Verarbeitung",
        "datenschutz_purpose_body": "Die Verarbeitung erfolgt zur Kontoverwaltung, Anfragebearbeitung, Orakeldeutung, Zahlungsabwicklung, Kundenkommunikation, Sicherheit, Fehleranalyse und Qualitätsverbesserung.",
        "datenschutz_legal_title": "Rechtsgrundlagen",
        "datenschutz_legal_body": "Die Verarbeitung erfolgt auf Grundlage der Vertragserfüllung, berechtigter Interessen (Sicherheit/Betriebsstabilität) sowie – soweit erforderlich – auf Basis einer Einwilligung.",
        "datenschutz_storage_title": "Speicherdauer",
        "datenschutz_storage_body": "Daten werden nur so lange gespeichert, wie es für die Leistungserbringung und gesetzliche Pflichten erforderlich ist. Danach werden sie gelöscht oder anonymisiert.",
        "datenschutz_sharing_title": "Einsatz von Dienstleistern",
        "datenschutz_sharing_body": "Für Zahlung, E-Mail-Versand, Hosting und KI-gestützte Deutung können vertraglich gebundene Dienstleister eingesetzt werden. Es werden nur erforderliche Daten übermittelt.",
        "datenschutz_cookies_title": "Cookies und Sitzungsdaten",
        "datenschutz_cookies_body": "Die Plattform nutzt notwendige technische Cookies für sichere Sitzungen und Spracheinstellungen. Marketing-Tracking-Cookies werden nicht eingesetzt.",
        "datenschutz_security_title": "Datensicherheit",
        "datenschutz_security_body": "Wir setzen Zugriffskontrollen, Passwortschutz, HTTPS, Sitzungsabsicherung sowie technische und organisatorische Schutzmaßnahmen auf Infrastruktur-Ebene ein.",
        "datenschutz_transfer_title": "Internationale Datenübermittlung",
        "datenschutz_transfer_body": "Je nach Standort eingesetzter Dienstleister kann eine Verarbeitung außerhalb Ihres Landes erfolgen. In solchen Fällen werden vertragliche und technische Schutzmechanismen umgesetzt.",
        "datenschutz_rights_title": "Ihre Rechte",
        "datenschutz_rights_body": "Sie haben je nach Rechtslage insbesondere das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung, Widerspruch und Datenübertragbarkeit.",
        "datenschutz_contact_title": "Datenschutzkontakt",
        "datenschutz_contact_body": "Datenschutzanfragen: support@orakelia.com (Betreff: Datenschutz)",
