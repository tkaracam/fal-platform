...
TRANSLATIONS = {
    "tr": {
        ...
        "home_info_1_title": "✨ Orakelia – Spiritüel Yol Rehberin",
        "home_info_1_body": "Kaderinin mesajlarını keşfet.\nBazen hayat bizi aşk, gelecek ya da kararlarla ilgili sorularla karşı karşıya bırakır.\nOrakelia'da sana yeni bakış açıları ve netlik sunabilecek sezgisel bir spiritüel yorum alırsın.\n✨ Evrenin işaretleriyle yolunu aydınlat.\nKahve Falı • Tarot • Katina Aşk Falı\n🔮 Şimdi falını başlat",
        "home_info_2_title": "🌙 Neden Orakelia?",
        "home_info_2_body": "Orakelia'da odağımız saygılı ve sezgisel yorumlamadır.\n✨ Kişisel yorum\n✨ Spiritüel gelenekler\n✨ Gizli ve güvenli danışmanlık\n✨ Kolay online kullanım\nBirçok kişi yön bulmak ve yeni bir bakış açısı kazanmak ister.\nYorumlar sana ilham vermek ve düşünmeye alan açmak için hazırlanır.",
        "home_info_3_title": "🧭 Nasıl Çalışır?",
        "home_info_3_body": "1️⃣ Fal türünü seç\n2️⃣ Fotoğrafını yükle veya kartlarını seç ve sorunu yaz.\n3️⃣ Kişisel yorumunu al",
    ...
    "en": {
        ...
        "home_info_1_body": "Discover the messages of your destiny.\nSometimes life confronts us with questions about love, the future, or important decisions.\nAt Orakelia, you receive an intuitive spiritual interpretation that can offer fresh perspective and clarity.\n✨ Let the signs of the universe guide you.\nCoffee Reading • Tarot • Katina Love Oracle\n🔮 Start your reading now",
        "home_info_2_title": "🌙 Why Orakelia?",
        "home_info_2_body": "At Orakelia, respectful and intuitive interpretation is at the center.\n✨ Personal interpretation\n✨ Spiritual traditions\n✨ Discreet guidance\n✨ Easy online use\nMany people seek orientation and new perspectives.\nThese interpretations are meant to inspire you and open space for reflection.",
        "home_info_3_title": "🧭 How It Works",
        "home_info_3_body": "1️⃣ Choose your reading type\n2️⃣ Upload your photo or choose your cards and ask your question.\n3️⃣ Receive your personal interpretation",
    ...
    "de": {
        ...
        "home_info_1_body": "Entdecke die Botschaften deines Schicksals.\nManchmal stellt uns das Leben vor Fragen über Liebe, Zukunft oder Entscheidungen.\nBei Orakelia erhältst du eine intuitive spirituelle Deutung, die dir neue Perspektiven und Klarheit geben kann.\n✨ Lass dich von den Zeichen des Universums leiten.\nKaffeesatzlesen • Tarot • Katina Liebesorakel\n🔮 Jetzt dein Orakel starten",
        "home_info_2_title": "🌙 Warum Orakelia?",
        "home_info_2_body": "Bei Orakelia steht eine respektvolle und intuitive Deutung im Mittelpunkt.\n✨ Persönliche Interpretation\n✨ Spirituelle Traditionen\n✨ Diskrete Beratung\n✨ Einfache Online-Nutzung\nViele Menschen suchen Orientierung oder neue Perspektiven.\nDie Deutungen sollen dich inspirieren und zum Nachdenken anregen.",
        "home_info_3_title": "🧭 So funktioniert es",
        "home_info_3_body": "1️⃣ Wähle dein Orakel\n2️⃣ Lade dein Bild hoch oder wähle deine Karten und stelle deine Frage.\n3️⃣ Erhalte deine persönliche Deutung",
